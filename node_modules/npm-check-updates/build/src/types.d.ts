...
export declare type Maybe<T = any> = T | null | undefined;
/** A function that gets a target version of a dependency. */
export declare type GetVersion = (packageName: string, currentVersion: Version, options?: Options) => Promise<Version | null>;
...
export declare type TargetString = 'latest' | 'newest' | 'greatest' | 'minor' | 'patch';
export declare type Target = TargetString | TargetFunction;
...
export declare type Options = RunOptions & {
    args?: any[];
    cli?: boolean;
    json?: boolean;
